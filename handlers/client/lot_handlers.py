...
@router.callback_query(F.data == 'my_auctions')
...
@router.callback_query(FSMClient.currency)
...
@router.message(FSMClient.description, IsMessageType(message_type=[ContentType.TEXT]))
...
@router.message(FSMClient.price)
...
@router.message(FSMClient.price_steps)
...
@router.callback_query(FSMClient.lot_time_living)
...
@router.message(FSMClient.media)
@router.message(FSMClient.change_media)
@router.callback_query(F.data == 'back_to_ready')
@media_group_handler
...
@router.callback_query(UserNotBlockedFilter(), F.data.startswith('bid'))
@require_username
@create_user_group
...
@router.callback_query(F.data == 'show_lot')
@router.callback_query(FSMClient.change_lot)
...
@router.callback_query(F.data == 'change_start_price')
...
@router.callback_query(F.data == 'change_lot_time')
...
@router.callback_query(F.data == 'change_price_steps')
...
@router.message(FSMClient.change_start_price)
...
@router.callback_query(F.data == 'delete_lot')
...
@router.callback_query(F.data.startswith('accept_lot'))
...
@router.callback_query(F.data.startswith('decline_lot'))
...
@router.callback_query(F.data.startswith('lot_deletion_'))
...
@router.callback_query(F.data == 'anti_sniper')
...
@router.callback_query(FSMClient.sniper_time)
...
@router.callback_query(F.data.startswith('edit_lot_text'))
